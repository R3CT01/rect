...
import 'package:aura/pages/usersettingsnotifications.dart';
...
class UserSettingsProfile extends StatefulWidget {
  UserSettingsProfile({super.key});

  @override
  State<UserSettingsProfile> createState() => _UserSettingsProfileState();
}

class _UserSettingsProfileState extends State<UserSettingsProfile> {
  @override
